function [Xr,FVAL,REASON,OUTPUT,POPULATION,SCORES] = geneticoptimizationmod
close all
clc
close all hidden
%%Fitness function
...
% run GA
[Xr,FVAL,REASON,OUTPUT,POPULATION,SCORES] = ga(fitnessFunction,nvars,Aineq,Bineq,Aeq,Beq,LB,UB,nonlconFunction,options);
% Displaying results

disp ('Values of optimized parameters: ');
temp = approx_quantization(Xr); 
disp (temp);
